...
public class Roundabout {
    public static void main(String[] args) {
        ...
        T1Ct1.SetNextCondition(LogicConnector.AND, T3Ct2);
        ...
        grdT5.Activations.add(new Activation(t5, "P1", TransitionOperation.AddElement, "P5"));
        ...
        Condition T6Ct2 = new Condition(t5, "P2", TransitionCondition.CanAddCars);
